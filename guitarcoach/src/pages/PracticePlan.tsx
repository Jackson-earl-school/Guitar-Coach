        ...
        {activeTab === "generate" && (
          <>
            <div className="pp-form">
              ...
              />
              <button className="generate-btn" disabled={!canGenerate} onClick={generatePlan}>
              ...
              <div className="pp-results">
                ...
                <div className="pp-summary-row">
                  <div className="info-box pp-summary-box">
                    ...
                    <p className="pp-song-detail"><span className="pp-song-detail-label">Level:</span> {result.skill_level}</p>
                    <button
                          ...
                          return (
                            <div key={taskIndex} className="pp-task-card">
                              ...
                              >
                                ...
                                <span className="pp-task-meta">{task.duration_minutes}m {isOpen ? "▲" : "▼"}</span>
                              </div>
                              {isOpen && (
