        ...
        <div className="home-page">
            ...
            <section className="guitarcoach-intro">
                <div className="intro-content">
                    ...
                    <p className="intro-description"> Link your Spotify account to receive song recommendations based on your listening history paired with personalized coaching. </p>
